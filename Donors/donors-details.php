      ...
      <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
              <ul class="navbar-nav ml-auto">
                  <li class="nav-item">
                      <a class="nav-link" href="#" onclick="displaySection('personal-info')"><i class="fas fa-user"></i>Personal Information</a>
                  </li>
                  <li class="nav-item">
                      <a class="nav-link" href="#" onclick="displaySection('membership-info')"><i class="fas fa-certificate"></i>Membership Information</a>
                  </li>
                  <li class="nav-item">
                      <a class="nav-link" href="#" onclick="displaySection('donation-history')"><i class="fas fa-donate"></i>Donation History</a>
                  </li>
                  <li class="nav-item">
                      <a class="nav-link" href="#" onclick="displaySection('sponsorships')"><i class="fas fa-hand-holding-heart"></i>Sponsorships</a>
                  </li>
              </ul>
          </div>
      </nav>

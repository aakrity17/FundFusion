...
if (isset($_SESSION['name'])) {
    ...
    $sql2 = "SELECT * FROM Sponsorship WHERE id = '$title'";
...
<body>
    ...
    <section class="main">
        <div class="donation-container">
            ...
            <form class="donation-form" action="toSponsorKhalti.php" method="POST">
                ...
                <div class="form-control" hidden>
                    <input type="text" value="<?php echo $title; ?>" name="sponsor_id" >
                    <i class="fas fa-user"></i>
                </div>

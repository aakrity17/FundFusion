...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light nav-bg fixed-top py-2" id="mainNav">
        <div class="container">
            <a class="navbar-brand text-white" href="#">Fund Fusion</a>
                ...
                <div class="col-md-8">
                    <div class="tab-content">
                        <div class="tab-pane container p-0 active" id="about-1">
                            <div class="img" style="background-image: url(/img/11.jpg);"></div>
        ...
        <div class="stories">
            <div class="container">
                <div class="section-title text-center">
                    <h3>Necessities</h3>
                    <p>Some necessary things that we need to remember for the betterment of animals. As we are working
                ...
                <!-- <div class="row">
                    <div class="col-md-4">
                        <div class="story-box overlay shadow">
                            ...
                            <h2>Health</h2>
                            <p>HealthforAnimals represents the animal health sector: manufacturers of veterinary
                    ...
                    <!-- <div class="col-md-4">
                        <div class="story-box overlay shadow">
                            ...
                            <h2>Proper Food</h2>
                            <p>In terms of diet, three types of animals exist: carnivores, herbivores and omnivores. At
    ...
    <section class="project py-5">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-10 col-md-6 col-lg-4">
                    <div class="project-container p-5 outline">
                        <img src="img/9.jpg" class="img-fluid grow" alt="">
                        <a herf="#" class="donation text-capitalize">Donate Now</a>
                    </div>
                    <h4 class="text-capitalize text-center my-2">Project-1</h4>
                    <h6 class="text-center">
                ...
                <div class="col-10 col-md-6 col-lg-4">
                    <div class="project-container p-5 outline">
                        <img src="img/bg.jpg" class="img-fluid grow" alt="">
                        <a herf="#" class="donation text-capitalize">Donate Now</a>
                    </div>
                    <h4 class="text-capitalize text-center my-2">Project-1</h4>
                    <h6 class="text-center">

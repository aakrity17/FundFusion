...
<div class="container-1">
  <div class="buttons">
    <a href="paymentGateway.php?title=<?php echo 1; ?>" class="btn btn-primary">Register for Premium</a>
    <a href="paymentGateway.php?title=<?php echo 2; ?>" class="btn btn-primary">Register for Regular</a>
    <a href="paymentGateway.php?title=<?php echo 3; ?>" class="btn btn-primary">Register for VIP</a>
  </div>
</div>
